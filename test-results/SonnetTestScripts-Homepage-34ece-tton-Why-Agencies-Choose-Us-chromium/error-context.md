...
- Name: SonnetTestScripts\Homepage\SonnetHomepage.test.ts >> Hero Section Button Why Agencies Choose Us
- Location: SonnetTestScripts\Homepage\SonnetHomepage.test.ts:18:5
...
Locator: getByRole('link', { name: 'Why Agencies Choose Us', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Why Agencies Choose Us', exact: true })
